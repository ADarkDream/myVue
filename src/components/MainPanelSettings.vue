<template>
  <div>
    ...
    <el-form v-model="bgSettings" class="mainPanelSettings">
      ...
      <el-form-item label="透明度">
        <el-input-number
          v-model="bgSettings['--main-panel-bg-opacity']"
          :max="1"
          :min="0"
          :step="0.01"
          type="number"
      ...
      <el-form-item label="模糊度">
        <el-input-number
          v-model="bgSettings['--main-panel-bg-filter']"
          :min="0"
          :step="0.01"
          type="number"
        />
      ...
      <el-form-item label="饱和度">
        <el-input-number
          v-model="bgSettings['--main-panel-bg-saturate']"
          :min="0"
          :step="0.01"
          type="number"
        />
  ...
  <div style="height: 200px">
    ...
    <div style="text-align: left">
      播放前显示播放器<el-switch v-model="is_show_player_before_play" />
    </div>
  </div>
</template>
