<template>
  ...
  <el-menu v-if="isPC" class="el-menu-vertical-demo" :collapse="isCollapse" default-active="0">
    <!--   控制菜单-->
    <el-menu-item active-class="active" index="0" @click="toContent(0)">
      <svg class="el-icon" p-id="5814" t="1712740370355" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <el-menu-item active-class="active" index="1" @click="toContent(1)">
      <svg class="el-icon" p-id="10503" t="1712740609200" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <el-menu-item active-class="active" index="2" @click="toContent(2)">
      <svg class="el-icon" p-id="4699" t="1712740316505" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <el-menu-item active-class="active" index="3" @click="toContent(3)">
      <svg class="el-icon" p-id="6913" t="1712740428321" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        <path
          ...
          data-spm-anchor-id="a313x.search_index.0.i16.2ca13a81IftKnS"
          fill="currentColor"
          p-id="6915"
        ></path>
      </svg>
    ...
    <el-menu-item active-class="active" index="4" @click="toContent(4)">
      <svg
        class="el-icon"
        height="200"
        p-id="1655"
    ...
    <el-menu-item active-class="active" index="5" @click="toContent(5)">
      <svg
        class="el-icon"
        height="200"
        p-id="2741"
    ...
    <el-menu-item active-class="active" index="6" @click="toContent(6)">
      <svg class="el-icon" p-id="8315" t="1712740489529" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <el-menu-item active-class="active" index="7" @click="toContent(7)">
      <svg
        class="el-icon"
        height="200"
        p-id="6684"
    ...
    <el-menu-item active-class="active" index="8" @click="toContent(8)">
      <svg
        class="el-icon"
        height="200"
        p-id="10535"
    ...
    <el-menu-item active-class="active" index="9" @click="toContent(9)">
      <svg
        class="el-icon"
        height="200"
        p-id="5595"
      ...
      >
        ...
        ></path>
        <path
          d="M667.434667 393.130667m-45.696 0a45.696 45.696 0 1 0 91.392 0 45.696 45.696 0 1 0-91.392 0Z"
          fill="currentColor"
          p-id="5597"
        ></path>
        <path
          d="M758.869333 502.869333m-45.696 0a45.696 45.696 0 1 0 91.392 0 45.696 45.696 0 1 0-91.392 0Z"
          fill="currentColor"
          p-id="5598"
        ></path>
        <path
    ...
    <!--    侧边栏折叠和展开-->
    <!--    <el-menu-item class="change" index="0" @click="isCollapse=!isCollapse">-->
    <!--      <el-icon>-->
    <!--        <Switch/>-->
    <!--      </el-icon>-->
  ...
  <!--    侧边栏折叠和展开-->
  <el-menu v-if="isPC" class="change" :collapse="true" @click="isCollapse = !isCollapse">
  ...
  <!--  移动端侧边导航栏-->
  <el-drawer v-if="!isPC" v-model="showAside" direction="ltr" :show-close="false" size="50%" :with-header="false">
    <h4>导航列表</h4>
