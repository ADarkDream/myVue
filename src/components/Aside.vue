<template>
  <!--  default-active页面加载时默认呈现的列表-->
  <el-menu default-active="0" class="el-menu-vertical-demo show" :collapse="isCollapse">
    <!--   控制菜单-->

    <el-menu-item index="0" active-class="active" @click="emitter.emit('getListNum',0);emitter.emit('showContent')">
      <svg t="1712740370355" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="5814">
        <path
      ...
      <template #title>&ensp;软件下载</template>
    </el-menu-item>
    <el-menu-item index="1" active-class="active" @click="emitter.emit('getListNum',1);emitter.emit('showContent')">
      <svg t="1712740609200" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="10503">
        <path
      ...
      <template #title>&ensp;在线工具</template>
    </el-menu-item>
    <el-menu-item index="2" active-class="active" @click="emitter.emit('getListNum',2);emitter.emit('showContent')">
      <svg t="1712740316505" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="4699">
        <path
      ...
      <template #title>&ensp;机器人</template>
    </el-menu-item>
    <el-menu-item index="3" active-class="active" @click="emitter.emit('getListNum',3);emitter.emit('showContent')">
      <svg t="1712740428321" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="6913">
        <path
            d="M145 96l66 746.6L511.8 928l299.6-85.4L878.7 96H145z m610.9 700.6l-244.1 69.6-245.2-69.6-56.7-641.2h603.8l-57.8 641.2z"
            p-id="6914" fill="#FFF"></path>
        <path
            ...
            p-id="6915" fill="#FFF" data-spm-anchor-id="a313x.search_index.0.i16.2ca13a81IftKnS"
            class="selected"></path>
      </svg>
      <template #title>&ensp;HTML</template>
    </el-menu-item>
    <el-menu-item index="4" active-class="active" @click="emitter.emit('getListNum',4);emitter.emit('showContent')">
      <svg t="1716391588246" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <el-menu-item index="5" active-class="active" @click="emitter.emit('getListNum',5);emitter.emit('showContent')">
      <svg t="1716391718743" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <el-menu-item index="6" active-class="active" @click="emitter.emit('getListNum',6);emitter.emit('showContent')">
      <svg t="1712740489529" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="8315">
        <path
...
<svg t="1716392175783" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10535" width="200" height="200"><path d="M85.333333 213.333333a85.333333 85.333333 0 0 1 85.333334-85.333333h682.666666a85.333333 85.333333 0 0 1 85.333334 85.333333v85.333334c0 31.872-17.493333 59.669333-43.370667 74.325333 0.469333 3.605333 0.704 7.274667 0.704 11.008v426.666667a85.333333 85.333333 0 0 1-85.333333 85.333333H213.333333a85.333333 85.333333 0 0 1-85.333333-85.333333V384c0-3.733333 0.234667-7.402667 0.704-11.008A85.312 85.312 0 0 1 85.333333 298.666667v-85.333334z m768 85.333334v-85.333334H170.666667v85.333334h682.666666z m-640 85.333333v426.666667h597.333334V384H213.333333z m128 128a42.666667 42.666667 0 0 1 42.666667-42.666667h256a42.666667 42.666667 0 1 1 0 85.333334H384a42.666667 42.666667 0 0 1-42.666667-42.666667z" fill="#ffffff" p-id="10536"></path></svg>
    ...
    <el-menu-item index="9" active-class="active" @click="emitter.emit('getListNum',9);emitter.emit('showContent')">
      ...
      <template #title>&ensp;娱乐</template>
    </el-menu-item>
  </el-menu>

  <el-menu class="change show" @click="extend" :collapse="true">
    <el-menu-item index="0">
      <el-icon>
        <Switch/>
      </el-icon>
      <template #title>精简/展开</template>
    </el-menu-item>
  </el-menu>
...
import {ref} from 'vue'
import {Reading, Switch, VideoPlay} from '@element-plus/icons-vue'
