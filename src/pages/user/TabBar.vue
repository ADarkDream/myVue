  ...
  <div class="tabBar">
    ...
    <menu ref="menu" class="menu">
      ...
      <div :class="index === 2 ? 'menu__item active' : 'menu__item'" style="--bgColorItem: #65ddb7" @click="clickItem(2)">
        <svg class="icon" height="100" viewBox="0 0 24 24" width="100" xmlns="http://www.w3.org/2000/svg">
...
const offsetMenuBorder = (element: HTMLDivElement) => {
  ...
  const left =
    Math.floor(offsetActiveItem.left - menu.value.offsetLeft - (menuBorder.value.offsetWidth - offsetActiveItem.width) / 2) + "px"
