<template>
        ...
        <el-table-column fixed="right" label="操作" min-width="140">
          <template #default="scope">
            ...
            <el-button
              ...
              size="small"
              type="danger"
              @click="deleteRow(scope.row.id, 0)"
            >
              删除
            </el-button>
          </template>
        ...
        <el-table-column fixed="right" label="操作" min-width="100">
          <template #default="scope">
            ...
            <el-button
              ...
              size="small"
              type="danger"
              @click="deleteRow(scope.row.id, 1)"
              >删除</el-button
            >
          </template>
        </el-table-column>
  ...
  <el-footer v-if="!tableVisible">
      ...
      <el-container>
        <el-main class="cards">
          ...
          <el-card v-for="(item, index) in draftList" class="card" :key="index">
            ...
            <template #footer>
              <div class="footer">
                <el-button type="primary" @click="goEdit(item, 1)"
                  >编辑</el-button
                >
                <el-button type="danger" @click="deleteMyDraft(item.id)"
                  >删除</el-button
                >
              </div>
            </template>
      ...
      <el-container>
        <el-main class="cards">
          ...
          >
            ...
            <template #footer>
              <div class="footer">
                <el-button type="info" @click="goArticle(item, 0)"
                  >查看</el-button
                >
                <el-button type="primary" @click="goEdit(item, 0)"
                  >编辑</el-button
                >
                <el-button type="danger" @click="deleteMyArticle(item.id)"
                  >删除</el-button
                >
              </div>
            </template>
    ...
    <div class="div">
      <el-container>
        <el-main class="cards">
          <el-button class="title" text type="danger"
            >审核未通过(修改之后可再次审核)</el-button
          >
      ...
      <el-container>
        <el-main class="cards">
          ...
          >
            ...
            <template #footer>
              <div class="footer">
                <el-button type="info" @click="goArticle(item, 1)"
                  >查看</el-button
                >
                <el-button type="primary" @click="goEdit(item, 1)"
                  >编辑</el-button
