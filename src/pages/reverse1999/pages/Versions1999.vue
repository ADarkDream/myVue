  ...
  <div class="versions1999">
    <div class="header">
      <el-button
        :icon="Plus"
        type="primary"
        @click="toggleAddVersionDrawer(true)"
        >新增版本信息</el-button
      >
      <el-button :icon="Refresh" plain type="success" @click="refreshVersion()"
        >刷新</el-button
      >
    </div>
    <el-table
    ...
    >
      ...
      >
        <template #default="scope">
          <el-tag v-for="time in scope.row.time" :key="time" type="primary"
            >{{ time }}
          </el-tag>
        </template>
      </el-table-column>
...
//components
const AddVersion = defineAsyncComponent(
  () => import("../components/AddVersion.vue")
);
//utils
