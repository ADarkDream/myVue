  ...
  <div class="downloadNotice">
    ...
    <el-tabs v-model="showNum" @tab-click="tabClick">
      ...
      <el-tab-pane label="少量下载" :name="1">
        <el-card>
          <p class="title">
            默认情况下，你可以一次性批量下载最多{{ downloadLimitNum }}张图片。
          </p>
          <p>
            1.如果你下载的数量不多，
          ...
          <p>
            2.如果你要一次性下载更多图片，请查看
            <el-link type="primary" @click="changePage(2)"
              >下载大量(仅限PC)</el-link
            >
            。
          </p>
      ...
      <el-tab-pane label="下载大量(仅限PC)" :name="2">
        <el-card>
          ...
          <p>
            1.点击下载
            <el-link
              href="https://wwqb.lanzout.com/iN0An2iuvrrg"
              target="_blank"
              type="success"
            >
              EXE格式(14.7MB)
          ...
          <p>
            2.点击下载
            <el-link
              href="https://wwqb.lanzout.com/inNks2iuwojg"
              target="_blank"
              type="success"
              >JS脚本压缩包(2.4MB)
            </el-link>
          ...
          <p>
            3.另有下载器
            <el-link
              href="https://wwqb.lanzout.com/iNPEp2iuvrih"
              target="_blank"
              type="success"
            >
              EXE格式(14.9MB) </el-link
            >，使用方式请查看
            <el-link
      ...
      <el-tab-pane label="其它说明" :name="3">
        <el-collapse v-model="activeNum" accordion>
          ...
          <el-collapse-item :name="3" title="Q：还有什么要狡辩的吗？">
            <p class="title">A：</p>
            <p>
              1.本着为爱发颠为大家提供这个便利功能(虽然平时用不上)，希望大家多多支持(遇到bug热心反馈一下)！
            </p>
            <p>
              2.关于下载的脚本，可前往
              <el-link
                title="Github 和 Gitee"
                type="primary"
              ...
              <Transition name="transition1">
                <el-link
                  v-if="showUrl"
                  href="https://github.com/ADarkDream/Download-Reverse1999"
                  target="_blank"
                  type="primary"
                >
                  GitHub
...
const { showFlag, showPayCodePanel, downloadLimitNum } = defineProps([
  "showFlag",
  "showPayCodePanel",
  "downloadLimitNum",
]); //切换页面的参数
